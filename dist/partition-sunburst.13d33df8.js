...
},{}],"partition-sunburst.ts":[function(require,module,exports) {
"use strict";
...
function draw() {
  return __awaiter(this, void 0, void 0, function () {
    var cityData, hierachy, partition, nodes, links, color, arc, gArc;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
        ...
        case 1:
          ...
          partition = d3.partition().size([2 * Math.PI, radius])(hierachy);
          ...
          gArc = svg.selectAll(".gArc").data(nodes.filter(function (d) {
            return d.depth;
          })).join("g").attr("pointer-events", "none").attr("text-anchor", "middle").attr("font-size", 10);
          gArc.append("path").attr("d", arc).attr("stroke", "#fff").attr("fill-opacity", 0.6).attr("fill", function (d) {
            var p = d;
          ...
          gArc.append("text").text(function (d) {
            return d.data.name;
          }).attr("transform", function (d) {
            var x = (d.x1 + d.x0) * 180 / Math.PI / 2;
            return "rotate(" + (x - 90) + ") translate(" + (d.y1 + d.y0) / 2 + ") rotate(" + (x < 180 ? 0 : 180) + ")";
          });
          return [2
          /*return*/
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","partition-sunburst.ts"], null)
//# sourceMappingURL=/partition-sunburst.13d33df8.js.map