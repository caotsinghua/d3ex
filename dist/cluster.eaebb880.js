...
},{}],"cluster.ts":[function(require,module,exports) {
"use strict";
...
function drawTree() {
  return __awaiter(this, void 0, void 0, function () {
    var data, hierachy, cluster, link, gTree, links, nodes, svgLinks, node;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          data = _a.sent();
          hierachy = d3.hierarchy(data, function (d) {
            return d.children;
          });
          cluster = d3.cluster().size([360, width / 2 - 130]).separation(function (a, b) {
            return (a.parent == b.parent ? 1 : 2) / b.depth;
          });
          cluster(hierachy);
          link = d3.linkRadial().angle(function (d) {
            return d.x / 180 * Math.PI;
          }).radius(function (d) {
            return d.y;
          });
          gTree = svg.append("g").attr("transform", "translate(" + width / 2 + "," + width / 2 + ")");
          links = hierachy.links();
          nodes = hierachy.descendants();
          console.log(nodes);
          svgLinks = gTree.selectAll(".link").data(links).enter().append("path").attr("d", function (d) {
            return link(d);
          }).attr("fill", "none").attr("stroke", "#444");
          node = gTree.selectAll(".node").data(nodes).enter().append("g").classed("node", true).attr("transform", function (d) {
            return "rotate(" + (d.x - 90) + ") translate(" + d.y + ",0)";
          });
          node.append("circle").attr("r", 4.5).attr("fill", d3.schemeCategory10[6]);
          node.append("text").attr("transform", function (d) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","cluster.ts"], null)
//# sourceMappingURL=/cluster.eaebb880.js.map