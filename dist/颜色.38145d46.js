...
function testColor() {
  ...
  var colorHsl = d3.hsl(120, 0.5, 0.5);
...
function testInterpolation() {
  ...
  var compute = d3.interpolateRgb(a, b);
  var data = d3.range(-0.5, 1.5, 0.1).map(function (n) {
    return compute(n);
  });
  var svg = d3.select("body").append("svg").attr("width", 400).attr("height", 400).style("border", "1px dashed");
  svg.selectAll("rect").data(data).enter().append("rect").attr("x", function (_, i) {
    return 10 + 10 * i;
  }).attr("y", function (_, i) {
    return 50;
  }).attr("width", 10).attr("height", 50).attr("fill", function (d) {
    return d.toString();
  });
}
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","颜色.ts"], null)
//# sourceMappingURL=/颜色.38145d46.js.map