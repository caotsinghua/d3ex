...
},{}],"partition.ts":[function(require,module,exports) {
"use strict";
...
var width = 900;
var height = 2400;
var svg = d3.select("body").append("svg").attr("width", width).attr("height", height).attr("viewBox", "0 0 " + width + " " + height).style("border", "1px dashed");

function parseData() {
  return __awaiter(this, void 0, void 0, function () {
    function getChildren(key) {
      var finded = source[key] || {};
      var start = Math.floor(Math.random() * 10);
      return Object.keys(finded).map(function (key) {
    ...
    var r, source, parsedSource;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          r = function r() {
            return Promise.resolve().then(function () {
              return __importStar(require("./city.json"));
            });
          };
...
function draw() {
  return __awaiter(this, void 0, void 0, function () {
    var cityData, hierachy, partition, nodes, links, color, gRects;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
        ...
        case 1:
          cityData = _a.sent();
          hierachy = d3.hierarchy(cityData).count();
          console.log(hierachy);
          partition = d3.partition().size([height, width])(hierachy);
          nodes = hierachy.descendants();
          links = hierachy.links();
          color = d3.scaleOrdinal(d3.quantize(d3.interpolateRainbow, partition.children.length + 1));
          console.log(color);
          gRects = svg.selectAll(".gRect").data(nodes).join("g").attr("transform", function (d) {
            return "translate(" + d.y0 + "," + d.x0 + ")";
          });
          gRects.append("rect").attr("width", function (d) {
            return d.y1 - d.y0;
          }).attr("height", function (d) {
            return d.x1 - d.x0;
          ...
          gRects.filter(function (d) {
            return d.x1 - d.x0 > 16;
          }).append("text") // .attr("x", (d) => (d.x1 + d.x0) / 2)
          // .attr("y", (d) => (d.y1 + d.y0) / 2)
          .attr("fill", "#fff").attr("dx", function (d) {
            return (d.y1 - d.y0) / 2;
          }).attr("dy", function (d) {
            return (d.x1 - d.x0) / 2;
          }).text(function (d) {
            return d.data.name;
          }).attr("text-anchor", "middle") // .style("writing-mode", "tb")
          .style("font-size", 10);
          return [2
          /*return*/
          ];
...
draw();
},{"d3":"../node_modules/d3/index.js","./city.json":"city.json"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","partition.ts"], null)
//# sourceMappingURL=/partition.d3cfbc22.js.map