...
function test1() {
  // quantize只能定义开始和结束
  var quantize = d3.scaleQuantize().domain([0, 2, 4, 10]).range([1, 100]);
  console.log(quantize(4.99));
  console.log(quantize(5));
  console.log(quantize.invertExtent(1)); //   分成n段，取中间的平均值

  var quantile = d3.scaleQuantile().domain([0, 4, 5, 10]).range([1, 10, 100]);
...
function test2() {
  // 定义域和值域都是离散的
  var ordinal = d3.scaleOrdinal().domain([1, 2, 3, 4, 5]).range([19, 20, 30, 40, 50]);
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","quantile.js"], null)
//# sourceMappingURL=/quantile.3fdb878a.js.map