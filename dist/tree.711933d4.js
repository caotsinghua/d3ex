...
function drawTree() {
  return __awaiter(this, void 0, void 0, function () {
    var data, hierachy, tree, link, gTree, links, nodes, svgLinks, node;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          tree = d3.tree().size([width * 2, height - 200]).separation(function (a, b) {
            return a.parent == b.parent ? 1 : 2;
          });
          tree(hierachy);
          link = d3.linkHorizontal().x(function (d) {
            return d.y;
          }).y(function (d) {
            return d.x;
          });
          gTree = svg.append("g").attr("transform", 'translate(50,0)');
          ...
          node.append("text").attr("text-anchor", function (d) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","tree.ts"], null)
